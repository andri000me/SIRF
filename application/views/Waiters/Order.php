...
<div class="container ubah" >
	<form class="form-horizontal" onSubmit="return validate()" method="post" action="<?php echo base_url() ?>Waiters/action_add_order/<?php echo $username?>/<?php echo $ID_Reservation?>">
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" onSubmit="return validate()" method="post" action="<?php echo base_url() ?>Waiters/action_ubah_order_detail/<?php echo $username?>/<?php echo $ID_Reservation?>">
						<div class="form-group">
	...
	<form class="form-horizontal" onSubmit="return validate()" method="post" action="<?php echo base_url() ?>Waiters/add_order/<?php echo $username?>/<?php echo $ID_Reservation?>">
		<h4>List Order :
			...
			<tr>
				...
				<tr>
					...
					<td>
						...
						<span> | </span>
						<a style="text-decoration: none"  title="Delete" href="<?php echo base_url()?>Waiters/action_delete_pesanan/<?php echo $key['id'] ?>/<?php echo $ID_Reservation?>/<?php echo $username?>" title="">
